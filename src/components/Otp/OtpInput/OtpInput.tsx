    ...
    <>
      ...
      <div className="w-full sm:hidden mb-6">
        <input
          ...
          className="w-full h-14 text-center text-xl font-bold border-2 border-gray-300 rounded-xl focus:outline-none focus:border-[#347469] text-black transition-colors disabled:bg-gray-200 placeholder:text-sm placeholder:font-normal placeholder:text-gray-400"
        />
      </div>

      {/* دسکتاپ: input های جداگانه */}
      <div className="hidden sm:flex gap-2 mb-6 justify-center" dir="ltr">
        {otp.map((digit, index) => (
          <input
            key={index}
            ref={(el) => {
