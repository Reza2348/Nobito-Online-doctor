...
const DoctorAppointments: React.FC<DoctorAppointmentsProps> = ({ doctor }) => {
  ...
  const handleClick = async (item: number) => {
    ...
    try {
      ...
      if (!user) {
        ...
        const redirectUrl = `/Feedback/Feedback-Doctor?doctorId=${encodeURIComponent(
          String(doctor.id),
        )}`;
      ...
      // -----------------------------------------
      // فعلاً شبیه‌سازی رزرو
      // -----------------------------------------

      toast.success("نوبت شما با موفقیت ثبت شد ✅");

      // -----------------------------------------
      // آدرس صفحه Feedback پزشک
      // -----------------------------------------

      const feedbackUrl = `/Feedback/Feedback-Doctor?doctorId=${encodeURIComponent(
        String(doctor.id),
      )}`;
            ...
            >
              ...
              <div className="mb-4 flex items-start justify-between gap-3">
                ...
                <button
                  ...
                  onClick={() =>
                    toast.info(
                      "این نوبت برای مشاوره حضوری در نظر گرفته شده است.",
                    )
                  }
                  className="
                    inline-flex
