  ...
  return (
    <article
      className={`
        ...
        ${read ? "border-gray-100" : "border-red-100 bg-red-50/30"}
      `}
    >
      {/* Unread Indicator */}
      {!read && (
        ...
        <div className="flex min-w-0 gap-4">
          ...
          <div
            className={`
              ...
              rounded-xl
              ${read ? "bg-gray-100 text-gray-400" : "bg-red-100 text-red-500"}
            `}
          >
            <FaBell />
          </div>
