    ...
    <div className="hidden lg:flex items-center justify-between w-full px-4 py-2">
      ...
      <div className="flex items-center gap-8">
        <div className="flex items-center gap-6 text-[13px] text-gray-500 font-medium">
          ...
          <H.Link href="/FAQ" className="hover:text-black transition-colors">
            سوال های متداول
          </H.Link>
        </div>
        ...
        <Link
          href="/Map"
          className="flex items-center gap-1 text-sm text-gray-500 hover:text-black pr-4 transition-colors"
        >
          ...
          <span className="cursor-pointer">انتخاب آدرس</span>
        </Link>
      </div>
    </div>
  );
