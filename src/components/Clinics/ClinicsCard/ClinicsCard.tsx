...
const ClinicsCard: React.FC<ClinicsCardProps> = ({ clinic }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className="flex flex-col bg-white rounded-2xl shadow-md hover:shadow-2xl hover:scale-105 transition-shadow overflow-hidden w-full sm:max-w-75 lg:max-w-87.5]  cursor-pointer"
    >
